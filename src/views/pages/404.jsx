...
export default function PageNotFound() {
    ...
    return (
        <div className={ componentWrapper.default + 'h-full' }>
            <div className='flex flex-col h-full items-center justify-center gap-5 p-5'>
                ...
                <ul className='list-disc pl-5 mb-5'>
                    ...
                    <li>The URL wasn&apos;s correct when it was originally set up or it was linked incorrectly</li>
